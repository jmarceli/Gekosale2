      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          ...
          <ul class="labels unstyled">
            ...
            {% endif %}
            {% if product.new == 1 %}
            <li class="label-new">{% trans %}TXT_NEW_PRODUCT{% endtrans %}</li>
            {% endif %}
    ...
    <div class="span4">
      <div id="addToCart" class="well well-small">
        ...
        <ul>
          ...
          <li><span>{% trans %}TXT_DELIVERY_IN{% endtrans %} <strong>{{ product.availablityname }}</strong></span></li>
          {% endif %}
        </ul>
        <div class="hr"></div>
        <form>
          ...
          <a href="{{ path('frontend.contact', {"param": product.idproduct}) }}" class="btn btn-large btn-danger noavailable"><i class="icon-question-sign icon-white"></i> {% trans %}TXT_PRODUCT_REQUEST{% endtrans %}</a>
        </form>
      </div>
    </div>
  </div>
