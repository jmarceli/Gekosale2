...
<h2 class="category-title">{% trans %}TXT_SEARCH_RESULTS_FOR_QUERY{% endtrans %} <strong>"{{ phrase }}"</strong></h2>
<span class="category-info">{% trans %}TXT_FOUND_RESULTS{% endtrans %} {{ dataset.rows|length }}</span>
<div class="category-options">
  <form class="form-horizontal">
    <fieldset>
      <div class="control-group">
        <label class="control-label" for="sort">{% trans %}TXT_SORT_RESULTS{% endtrans %}:</label>
        <div class="controls">
  ...
  <div class="category-view">
    <span>{% trans %}TXT_VIEW_LABEL{% endtrans %}:</span>
